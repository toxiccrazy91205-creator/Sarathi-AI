...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    avatar: 'AK',
    quote:
      'Within 15 minutes I had a clear Year 1 and Year 2 action plan. I've already landed two internship interviews at companies the report specifically recommended targeting.',
  },
];
...
const METHODOLOGY = [
  ...
  },
  {
    ...
    description:
      'Our Gemini-powered engine doesn\'t just score you — it reasons about your trait combinations the way a seasoned career psychologist would, surfacing paths that generic tests miss entirely.',
    color: 'orange',
  },
  {
    icon: LineChart,
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Most students complete all 60 questions in 12–18 minutes. The questions are scenario-based and don\'t require any prior knowledge — just honest answers.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. We recommend revisiting every 6–12 months as your goals evolve. Each retake generates a fresh report, and your previous reports are saved in your dashboard.',
  },
  {
  ...
  return (
    <div className="min-h-screen bg-white antialiased">
      <main>
        ...
        <section
          id="home"
          className="relative overflow-hidden bg-[#0A2351] py-24 lg:py-32"
        >
          {/* Grid bg */}
          <div
            ...
            <div className="grid items-center gap-16 lg:grid-cols-2">
              ...
              <div className="max-w-2xl">
                ...
                <p className="mt-8 text-lg leading-relaxed text-white/70 sm:max-w-lg">
                  SARATHI is India's first AI-powered psychometric career platform
                  built specifically for college students. In 15 minutes, we map
                ...
                <p className="mt-5 text-sm font-medium text-white/40">
                  Free to take &nbsp;·&nbsp; Full PDF Roadmap unlocked for{' '}
                        ...
                        {[
                          ...
                          <div key={role}>
                            <div className="mb-1 flex items-center justify-between">
                              <p className="text-xs font-semibold text-[#0A2351]">
                                {role}
                              </p>
                              <span className="text-xs font-extrabold text-[#F57D14]">
                                {pct}%
                              </span>
                            </div>
                    ...
                    <div className="flex items-start gap-3 rounded-2xl bg-white/10 p-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-[11px] leading-relaxed text-white/60">
                          High analytical drive + systems thinking detected.
                          Build a public GitHub portfolio with 2 data projects
                          before semester end.
                        </p>
                      </div>
                    </div>
        ...
        <section className="border-b border-slate-100 bg-white py-14">
          <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 opacity-50 grayscale">
              {['SRM University', 'Delhi University', 'VIT Vellore', 'Amity University', 'KIIT', 'Manipal'].map(
                (college) => (
                  <span
                    key={college}
          ...
          <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-8 text-center md:grid-cols-3 md:divide-x md:divide-slate-200">
              {STATS.map(({ icon: Icon, value, label }) => (
                <div
                  key={label}
                  className="group flex flex-col items-center gap-2 pt-4 md:pt-0"
                >
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-base text-slate-500">
                No counselor appointments. No vague advice. Just a personalized,
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-slate-500">
                SARATHI combines validated psychometric frameworks — including
                Big Five personality theory, Holland Codes, and Self-Determination
                Theory — with Gemini 2.5 Flash to generate insights no generic
                test can match.
              </p>
            </div>
        ...
        <section
          id="about"
          className="scroll-mt-24 bg-[#0A2351] py-20 lg:py-28"
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <p className="mb-3 text-sm font-bold uppercase tracking-widest text-[#F57D14]">
                ...
                >
                  <div className="mb-4 flex gap-1">
                    {Array.from({ length: 5 }).map((_, i) => (
                      <Star
                        key={i}
                        className="h-4 w-4 fill-[#F57D14] text-[#F57D14]"
                      />
                    ))}
                  </div>
                  ...
                  <div className="mt-6 flex items-center gap-3 border
